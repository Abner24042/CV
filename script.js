document.addEventListener("DOMContentLoaded", () => {
    ...
    const dict = {
        ...
        "HTML5, CSS3, React": "HTML5, CSS3, React",
        "Node.js, PHP": "Node.js, PHP",
        "MongoDB, MySQL, Supabase": "MongoDB, MySQL, Supabase",
        "Pandas, NumPy, Power BI": "Pandas, NumPy, Power BI",
        "Git, GitHub": "Git, GitHub",
        "VS Code, Vite, MongoDB Compass, Cisco Packet Tracer, RStudio": "VS Code, Vite, MongoDB Compass, Cisco Packet Tracer, RStudio",
        ...
        "DentoCT — Composición de Radiografías Dentales": "DentoCT — Dental X-Ray Composition",
        "Uso clínico real": "Real clinical use",
        "Clínica Dental Privada — Proyecto Profesional": "Private Dental Clinic — Professional Project",
        "Aplicación web que automatiza la composición de radiografías periapicales en vistas panorámicas integradas, optimizando el flujo de revisión clínica odontológica.": "Web application that automates the composition of periapical X-rays into integrated panoramic views, optimizing the dental clinical review workflow.",
        "Desarrollo de interfaz web intuitiva orientada a personal odontológico no técnico.": "Developed an intuitive web interface tailored for non-technical dental staff.",
        "Módulo de carga y procesamiento de múltiples imágenes radiográficas con organización automática.": "Built a multi-image upload and processing module with automatic radiographic file organization.",
        "Generación dinámica de vistas panorámicas compuestas a partir de radiografías periapicales individuales.": "Implemented dynamic panoramic view generation from individual periapical X-ray inputs.",
        "Optimización de la visualización de imágenes médicas para análisis clínico preciso.": "Optimized medical image rendering for precise clinical analysis.",
        "Implementado con React, TypeScript y Vite — arquitectura moderna y código mantenible.": "Built with React, TypeScript and Vite — modern architecture with maintainable codebase.",
        "Solución en uso activo por profesional de odontología en entorno clínico real.": "Solution in active use by a dental professional in a real clinical environment.",
